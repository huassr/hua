<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"E:\hua/application/index\view\index\blog.html";i:1525404369;s:45:"E:\hua/application/index\view\index\base.html";i:1526815053;}*/ ?>
<!DOCTYPE HTML>
<html lang="en-US">
    <head>
        <meta charset="utf-8">
			...
			<div class="bg-wrapper">
				<section id="title-box" class="paralax bg-opacity-color blog-post">
					<div class="wrapper">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<h1>Blog</h1>
							<span class="subtitle">Latest News from MasterFarmer</span>
						</div>
					</div>
				</section>
...
<?php if(is_array($all) || $all instanceof \think\Collection || $all instanceof \think\Paginator): if( count($all)==0 ) : echo "" ;else: foreach($all as $key=>$vo): ?>

								<div class="blog-post-teaser wow fadeInUp">
									<div class="image-blog-post-block">
										<img class="full-width" src="<?php echo \think\Config::get('WEBSERVER'); ?>/public/hua/media/850x400/post1-img.jpg" alt="image">
									...
									<div class="info-box">
										<ul>
											...
											<li>
												<span class="ef icon_folder-open "></span>
												Hua.com
											</li>
											<li>
									...
									<a class="btn btn-border wow bounceInUp center" href="<?php echo url('index/index/readblog',array('id'=>$vo['id'])); ?>">
										<span>Read More</span>
									</a>
								</div>
						...
						<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
							...
							<div class="left-block-wrapper wow fadeInUp">
								...
								<div class="lb-content recent-posts">
									<ul>
										<li>
											<a href="." class="l-text-box">Lorem ipsum dolor sit amet sed consectetur adipisicing do</a>
											<span class="date">
							...
							<div class="left-block-wrapper wow fadeInUp">
								<div class="title-left-block">
									<h3 class="text-uppercase">Popular production</h3>
								</div>
								<div class="lb-content post-commented">
									<nav>
										<ul>
											...
											<li>
												<div class="item"><img width="100%" src="<?php echo \think\Config::get('WEBSERVER'); ?>/<?php echo $hvo['cover']; ?>" alt="image 1"></div>
												<div class="post-commented-text">
													<a href="." class="l-text-box"><?php echo $hvo['name']; ?></a>
													<span class="date">

														<a style="width: 100px;background: #e4ff00;padding: 10px 10px;text-align: center;" href="<?php echo url('index/index/buy',['id'=>$hvo['id']]); ?>" class="">Buy now</a>
													</span>
												</div>
											</li>
