<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"E:\hua/application/index\view\admin\queslist.html";i:1525404369;s:45:"E:\hua/application/index\view\admin\base.html";i:1526819111;s:45:"E:\hua/application/index\view\admin\head.html";i:1526719077;s:45:"E:\hua/application/index\view\admin\left.html";i:1525404369;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<link rel="stylesheet" href="<?php echo \think\Config::get('WEBSERVER'); ?>/public/hua/Fontss/css/font-awesome.css"/>
...
if(!isNaN('<?php echo $eq; ?>')){
  ...
  <div class="box box-solid">
    ...
    <div class="box-body">
      <form method="GET" action="<?php echo url('admin/queslist'); ?>" id='form'>
      <div class="row">
        <div class="col-xs-4 col-md-3">
          <div class="input-group">
            ...
            <span class="input-group-addon" onclick="$('#form').submit();"><i class="fa fa-search"></i></span>
              <?php if($_GET['word'] != ''): ?>
            <a title='清除条件' class="input-group-addon" href="<?php echo url('admin/queslist'); ?>"><i class="fa fa-remove"></i></a>
            <?php endif; ?>
          </div>
        </div>
      </div>
    ...
    <div class="box-body">
      <table class="table table-bordered">
        <tbody>
          ...
          <tr>
            <td><?php echo $vo['id']; ?></td><td><?php echo $vo['title']; ?></td>
            <td><?php echo $vo['nickname']; ?></td>
        <td><?php echo date("Y-m-d H:i",$vo['addtime']); ?></td>

            <td>
              <?php if($vo['answer'] == ''): ?>
                <a href="javascript:reply('<?php echo $vo['id']; ?>','<?php echo $vo['content']; ?>')" class="btn btn-success">回复</a>
                <?php else: ?>
...
function replyques(){
  ...
  $.post("<?php echo url('index/admin/replyques'); ?>",{'id':$("input[name='qid']").val(),'answer':ans},function(data){
