<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"E:\hua/application/index\view\index\stat.html";i:1525404369;s:45:"E:\hua/application/index\view\index\base.html";i:1526717809;}*/ ?>
<!DOCTYPE HTML>
<html lang="en-US">
    <head>
        <meta charset="utf-8">
  ...
  <div class="wrapper">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="section-title-box title-box-center wow bounceInDown center">
        <h2>此花卉的托养到期日为 <?php echo $expire; ?></h2>
	<p>请在到期日之前将您的花卉领取走，我们为您保留7天的期限！</p>
      </div>
    </div>
    <div class="row-3-col">
...
<table class="table table-bordered">
  ...
  <tbody>
      ...
      <tr>
        <td>Height</td>
        <td><?php echo $info['weight']; ?>(cm)</td>
        <td>weight</td>
        <td><?php echo $info['weight']; ?>(g)</td>
      </tr>
...
<div class="alert alert-success" role="alert"><?php echo $info['text']; ?></div>


        <?php if($info['album'] != ''): if(is_array($info['album']) || $info['album'] instanceof \think\Collection || $info['album'] instanceof \think\Paginator): if( count($info['album'])==0 ) : echo "" ;else: foreach($info['album'] as $key=>$vo): ?>

          <div class="col-xs-6 col-md-3">
          <a href="#" class="thumbnail">
          <img src="<?php echo \think\Config::get('WEBSERVER'); ?>/<?php echo $vo; ?>" alt="...">
          </a>
          </div>

          <?php endforeach; endif; else: echo "" ;endif; else: ?>

          <h4>管理员还没有更新花卉近期照片，请您耐心等待.我们会定期更新你的花卉状态！</h4>
          <?php endif; else: ?>
        ...
        <script type="text/javascript">
          ...
          function login(){
              ...
              $.post("<?php echo url('index/index/login'); ?>",{'account':account,'password':password},function(data){
                  ...
                  if(data.code===1){
                        $("#loginmod").modal('hide');
                        var succ = `  <a href="javascript:logout()" class="btn extra-color text-uppercase pull-right">(<?php echo \think\Session::get('login_nick'); ?>)登出</a>
                          <a href="<?php echo url('index/index/myorder'); ?>"  class="btn extra-color text-uppercase pull-right" style="margin-right:10px;">我的订单</a>
                            <a href="<?php echo url('index/index/myask'); ?>"  class="btn extra-color text-uppercase pull-right" style="margin-right:10px;">我的咨询</a>
<a href="<?php echo url('index/index/myorder2'); ?>"  class="btn extra-color text-uppercase pull-right" style="margin-right:10px;">我的托养</a>`;
                            $("#loginarea").html(succ);
