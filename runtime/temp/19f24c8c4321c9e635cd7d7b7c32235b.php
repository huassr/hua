<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"E:\hua/application/index\view\index\shop.html";i:1525404369;s:45:"E:\hua/application/index\view\index\base.html";i:1526815243;}*/ ?>
<!DOCTYPE HTML>
<html lang="en-US">
    <head>
        <meta charset="utf-8">
				...
				<section class="two-columns">
					<div class="wrapper">
						...
						<a class="add-to-cart pull-left" href="<?php echo url('index/index/buy',array('id'=>$vo['id'],'type'=>2)); ?>"><span>申请代养</span></a><?php endif; ?>
														<a href="<?php echo url('index/index/buy',array('id'=>$vo['id'],'type'=>1)); ?>" class="add-to-cart pull-right"><span>买买买</span></a>
													...
													<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
														...
														<div class="rating pull-right">
															<?php $__FOR_START_255__=0;$__FOR_END_255__=$vo['level'];for($k=$__FOR_START_255__;$k < $__FOR_END_255__;$k+=1){ ?>

																	<span class="ef icon_star"></span>


															<?php } $__FOR_START_15618__=0;$__FOR_END_15618__=5-$vo['level'];for($k=$__FOR_START_15618__;$k < $__FOR_END_15618__;$k+=1){ ?>
...
<?php echo $flower->render(); ?>
						...
						<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
								...
								<div class="lb-content lb-content-accordion">
									<div id="accordion" class="accordion-l-box">
										...
										<h3>
											...
											<span class="title-accordion-menu-item">产品分类</span>
											<span class="ef accordion-icon"></span>
										</h3>
										<div>
											<ul id="fstat">
												<li data-id='1'><a href="<?php echo url('index/index/store',array('cate'=>1)); ?>">多肉植物</a></li>
												<li data-id='2'><a  href="<?php echo url('index/index/store',array('cate'=>2)); ?>">观叶植物</a></li>
												<li data-id='3'><a href="<?php echo url('index/index/store',array('cate'=>3)); ?>">草木之物</a></li>
												<li data-id='4'><a href="<?php echo url('index/index/store',array('cate'=>4)); ?>">室内植物</a></li>
												<li data-id='5'><a href="<?php echo url('index/index/store',array('cate'=>5)); ?>">水培植物</a></li>

												<li data-id='21'><a href="<?php echo url('index/index/store',array('type'=>2,'cate'=>1)); ?>">蔬菜瓜果</a></li>
											</ul>
										</div>
								...
								<div class="l-banner-block hover-banner">
									<a href="#">
										...
										<span class="text-banner">
											...
											<span class="desc-banner">xxx</span>
										</span>
									</a>
								</div>
							</div>
							<div class="left-block-wrapper">
								<div class="title-left-block">
									<h3 class="text-uppercase">xxxxx</h3>
								</div>
								<div class="lb-content featured-product">
									<a href="#">
										...
										<span class="f-product-descr">
											...
											<span class="product-desc">xxxxxxxxxxxx</span>
											<div class="rating">
												<span class="ef icon_star"></span>
												<span class="ef icon_star"></span>
												<span class="ef icon_star"></span>
...
<script type="text/javascript">
		var cid="<?php echo $cate; ?>";
		$("#fstat li[data-id='"+cid+"']").addClass('active');
