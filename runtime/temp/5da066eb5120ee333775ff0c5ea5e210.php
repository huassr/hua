<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:48:"E:\hua/application/index\view\admin\addblog.html";i:1525404369;s:45:"E:\hua/application/index\view\admin\base.html";i:1526719438;s:45:"E:\hua/application/index\view\admin\head.html";i:1526719077;s:45:"E:\hua/application/index\view\admin\left.html";i:1525404369;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
if(!isNaN('<?php echo $eq; ?>')){
  ...
  <div class="box box-solid">
    <div class="box-header with-border">
      <h3 class="box-title">添加/编辑博客</h3><a href="<?php echo url('admin/essaylist'); ?>" class='btn btn-default btn-xs pull-right'>返回列表</a>
    </div><!-- /.box-header -->
    <div class="box-body">
         <form method="POST" id='form'>
            ...
            <div class="form-group">
                <label>精彩片段url</label>
                <input type="url" name="frameurl" class="form-control" value="<?php echo $info['frameurl']; ?>">
            </div>
...
<div class="temp hide"><?php echo $info['content']; ?></div>
<script charset="utf-8" src="<?php echo \think\Config::get('WEBSERVER'); ?>/public/com/kindeditor/kindeditor.js"></script>
<script charset="utf-8" src="<?php echo \think\Config::get('WEBSERVER'); ?>/public/com/kindeditor/lang/zh_CN.js"></script>
<script type="text/javascript">
KindEditor.ready(function(K) {
    window.editor = K.create('#editor_id',{
      uploadJson:"<?php echo url('Common/upload'); ?>"
    });
