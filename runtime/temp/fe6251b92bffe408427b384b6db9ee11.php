<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"E:\hua/application/index\view\index\myorder2.html";i:1525404369;s:45:"E:\hua/application/index\view\index\base.html";i:1526815243;}*/ ?>
<!DOCTYPE HTML>
<html lang="en-US">
    <head>
        <meta charset="utf-8">
...
<?php if($orders != NULL): if(is_array($orders) || $orders instanceof \think\Collection || $orders instanceof \think\Paginator): if( count($orders)==0 ) : echo "" ;else: foreach($orders as $key=>$vo): ?>
        <div class="media">
        ...
        <div class="media-body">
          ...
          <p style="color:red;font-size:20px;">总金额:$<?php echo $vo['fee']; ?></p>
          <p>到期日:<?php echo date("Y-m-d H:i:s",$vo['expire']); ?></p>
          <p><?php echo date("Y-m-d H:i:s",$vo['addtime']); ?></p>
          <p>状态:<span class="label label-success">托养中</span></p>
          <a class="btn btn-warning" href="<?php echo url('index/index/stat',array('id'=>$vo['id'])); ?>"  style="padding:5px 10px">查看花卉状态</a>
            <a class="btn btn-warning" href="javascript:ordermore(<?php echo $vo['id']; ?>)"  style="padding:5px 10px">续时</a>
        </div>
      </div>
      <hr>
...
<?php if($orders != NULL): if($page == 1): ?>
        <a class="btn extra-color text-uppercase pull-right" style="padding:10px 5px" href="<?php echo url('index/index/myorder2'); ?>?p=1">1st page</a>
        <?php else: ?>
          <a class="btn extra-color text-uppercase pull-right" style="padding:10px 5px" href="<?php echo url('index/index/myorder2'); ?>?p=<?php echo $page-1; ?>">prev</a>
        <?php endif; ?>
      </div>
    <div class="col-md-6">
      <?php if($page == $maxpage): ?>
        <a class="btn extra-color text-uppercase" style="padding:10px 5px" href="<?php echo url('index/index/myorder2'); ?>?p=<?php echo $maxpage; ?>">Final</a>
      <?php else: ?>
      <a class="btn extra-color text-uppercase" style="padding:10px 5px" href="<?php echo url('index/index/myorder2'); ?>?p=<?php echo $page+1; ?>">Next page</a>
      <?php endif; endif; ?>
    </div>
...
function suborder(){
    ...
    $.post("<?php echo url('index/index/ordermore'); ?>",{'id':id,'time':time},function(data){
