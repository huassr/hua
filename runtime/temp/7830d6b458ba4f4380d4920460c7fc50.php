<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"E:\hua/application/index\view\admin\bloglist.html";i:1525404369;s:45:"E:\hua/application/index\view\admin\base.html";i:1526818308;s:45:"E:\hua/application/index\view\admin\head.html";i:1526719077;s:45:"E:\hua/application/index\view\admin\left.html";i:1525404369;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
if(!isNaN('<?php echo $eq; ?>')){
  ...
  <div class="box box-solid">
    <div class="box-header with-border">
      ...
      <a href="<?php echo url('admin/addblog'); ?>" class='btn btn-success btn-xs pull-right'>添加新闻</a>
    </div>
    <div class="box-body">
      <form method="GET" action="<?php echo url('index/admin/bloglist'); ?>" id='form'>
      <div class="row">
        <div class="col-xs-4 col-md-3">
          <div class="input-group">
            ...
            <span class="input-group-addon" onclick="$('#form').submit();"><i class="fa fa-search"></i></span>
              <?php if($_GET['word'] != ''): ?>
            <a title='清除条件' class="input-group-addon" href="<?php echo url('index/admin/bloglist'); ?>"><i class="fa fa-remove"></i></a>
            <?php endif; ?>
          </div>
        </div>
      </div>
            ...
            <td>
              <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href="<?php echo url('index/admin/addblog',array('id'=>$vo['id'])); ?>">编辑</a></li>
