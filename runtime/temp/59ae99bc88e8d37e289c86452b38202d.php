<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:51:"E:\hua/application/index\view\admin\flowerlist.html";i:1525404369;s:45:"E:\hua/application/index\view\admin\base.html";i:1526819111;s:45:"E:\hua/application/index\view\admin\head.html";i:1526719077;s:45:"E:\hua/application/index\view\admin\left.html";i:1525404369;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
if(!isNaN('<?php echo $eq; ?>')){
  ...
  <div class="box box-solid">
    <div class="box-header with-border">
      ...
      <a href="<?php echo url('Admin/addflower'); ?>" class='btn btn-success btn-xs pull-right'>添加花卉</a>
    </div>
    <div class="box-body">
      <form method="GET" action="<?php echo url('admin/flowerlist'); ?>" id='form'>
      <div class="row">
        <div class="col-xs-4 col-md-3">
          <div class="input-group">
            ...
            <span class="input-group-addon" onclick="$('#form').submit();"><i class="fa fa-search"></i></span>
              <?php if($_GET['word'] != ''): ?>
            <a title='清除条件' class="input-group-addon" href="<?php echo url('admin/flowerlist'); ?>"><i class="fa fa-remove"></i></a>
            <?php endif; ?>
          </div>
        </div>
      </div>
