<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"E:\hua/application/index\view\index\myask.html";i:1525404369;s:45:"E:\hua/application/index\view\index\base.html";i:1526815243;}*/ ?>
<!DOCTYPE HTML>
<html lang="en-US">
    <head>
        <meta charset="utf-8">
...
<a href="<?php echo url('index/index/myorder2'); ?>"  class="btn extra-color text-uppercase pull-right" style="margin-right:10px;">我的托养</a>
  ...
  <?php if(\think\Session::get('login_uid') != ''): ?>
    ...
    <div class="container" style="padding-top:20px;padding-bottom:20px;">
      ...
      <?php if(is_array($ques) || $ques instanceof \think\Collection || $ques instanceof \think\Paginator): if( count($ques)==0 ) : echo "" ;else: foreach($ques as $key=>$vo): ?>
      ...
      <div class="panel-group"  role="tablist" aria-multiselectable="true">
        ...
        <div class="panel-heading" role="tab">
          <h4 class="panel-title">
            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne<?php echo $vo['id']; ?>" aria-expanded="true" aria-controls="collapseOne">
             question ID<?php echo $vo['id']; ?>&nbsp <span class="pull-right"><?php echo date('Y-m-d H:i',$vo['addtime']); ?></span>
            </a><br>

          </h4>
        </div>
        <div id="collapseOne<?php echo $vo['id']; ?>" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
          <div class="panel-body">
            <p class="bg-danger"><?php echo $vo['title']; ?>:<?php echo $vo['content']; ?></p>
            <p style="color:red;font-size:20px;"><?php if($vo['answer'] != ''): ?><?php echo $vo['answer']; ?>At <?php echo date("Y-m-d H:i",$vo['restime']); else: ?>there is no any answer <?php endif; ?></p>
          </div>
        </div>
        </div>
