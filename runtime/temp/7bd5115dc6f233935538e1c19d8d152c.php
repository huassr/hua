<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"E:\hua/application/index\view\index\myadd.html";i:1525404369;s:45:"E:\hua/application/index\view\index\base.html";i:1525404369;}*/ ?>
<!DOCTYPE HTML>
<html lang="en-US">
    <head>
        <meta charset="utf-8">
                    ...
                    <div class="wrapper">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" id="loginarea">
                          <?php if(\think\Session::get('login_uid') != ''): ?>
                                  ...
                                  <a href="<?php echo url('index/index/myadd'); ?>"  class="btn extra-color text-uppercase pull-right" style="margin-right:10px;">我的地址</a>
...
<?php endforeach; endif; else: echo "" ;endif; ?>
 <div class="col-md-3 col-sm-12" style="background: grey">
