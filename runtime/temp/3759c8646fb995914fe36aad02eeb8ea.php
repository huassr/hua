<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"E:\hua/application/index\view\index\mycart.html";i:1525410208;s:45:"E:\hua/application/index\view\index\base.html";i:1526815243;}*/ ?>
<!DOCTYPE HTML>
<html lang="en-US">
    <head>
        <meta charset="utf-8">
...
<a href="<?php echo url('index/index/myorder2'); ?>"  class="btn extra-color text-uppercase pull-right" style="margin-right:10px;">我的托养</a>
  ...
  <?php if(\think\Session::get('login_uid') != ''): ?>
    ...
    <div class="container" style="padding-top:20px;padding-bottom:20px;">
      ...
      <?php if(is_array($cart) || $cart instanceof \think\Collection || $cart instanceof \think\Paginator): if( count($cart)==0 ) : echo "" ;else: foreach($cart as $key=>$vo): ?>

          <div class="col-md-12" style="margin-bottom: 10px;">
            <div class="col-md-3"><img class="img-responsive" style="width:200px;" src="<?php echo \think\Config::get('SERVER'); ?>/<?php echo $vo['cover']; ?>"></div>
            <div class="col-md-6">
              <h3><?php echo $vo['name']; ?><span style="color: red;font-size: 15px;"><?php echo $vo['price']; ?></span></h3>
              <p>数量:<input class="form-control num" data-pid="<?php echo $vo['pid']; ?>" data-id="<?php echo $vo['id']; ?>" data-price="<?php echo $vo['price']; ?>"  value="<?php echo $vo['num']; ?>"/></p>
            </div>
          </div><hr>
...
<button style="font-size20px;height:100px;position:fixed;bottom:0px;z-index:999;" class="btn btn-success btn-block" onclick="FillAddress()">确认下单(￥<span id="total"><?php echo $total; ?></span>)</div>
...
<script type="text/javascript">
  ...
  $.ajax({
    url:"<?php echo url('index/index/checktotal'); ?>",
...
$.ajax({
  url:"<?php echo url('index/index/DoOrder'); ?>",
  data:JSON.stringify(data),
  dataType:'JSON',
  method:"POST",
  success:function(ret){
